  ...
  void _itemOnClick(String path) {
    ...
    _videoPlayerController = VideoPlayerController.network(path)
      ..initialize().then((_) {
        ...
        Navigator.push(context, YmDialogRouter(YmVideoViewer(context, path, false, _videoPlayerController)));
      });
              ...
              child: Padding(
                  ...
                  child: Wrap(spacing: 5, runSpacing: 5, children: [
                    YmTextButton(
                      ...
                      onClick: () {
                        this._itemOnClick(
                            "http://bkt.ymbok.com/%E4%B8%96%E7%95%8C%E4%B8%8D%E4%BC%9A%E8%BD%BB%E6%98%93%E5%B4%A9%E5%A1%8C.mp4");
                      },
