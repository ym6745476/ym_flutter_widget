...
/// 虚线边框
class YmDashedBorder extends BoxBorder {
  ...
  const YmDashedBorder.symmetric({
  ...
  BoxBorder? add(ShapeBorder other, {bool reversed = false}) {
    if (other is YmDashedBorder &&
      ...
      return YmDashedBorder.merge(this, other);
    }
    return null;
  }
